...
// Re-export Recharts components for easier access
export {
  Area,
  Bar,
  CartesianGrid,
...
// Remove duplicate PayloadItem type
...
// Tooltip content props with type assertion for Recharts compatibility
interface ChartTooltipContentProps
  extends Omit<RechartsTooltipProps<number, string>, 'content' | 'formatter' | 'payload'>,
  ...
  // Use type assertion to handle the payload type
  payload?: any[];
...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, ChartTooltipContentProps>(
  (
    ...
    // Process payload to ensure it has the correct types
