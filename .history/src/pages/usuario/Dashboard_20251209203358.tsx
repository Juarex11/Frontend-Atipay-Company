...
/*************  ✨ Windsurf Command 🌟  *************/
  /**
   * Loads the minimum points required for a commission
   * @returns {Promise<number>} The minimum points required
    const loadGoal = async () => {
        const points = await getMinPointsRequired();
        setTargetPoints(points);
    };
/*******  da8b0040-49f6-43f3-afcd-ade8cc1b5d3f  *******/
    loadGoal();
}, []);
