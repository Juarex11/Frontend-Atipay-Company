    ...
    <AppLayout>
      <div className="p-6 space-y-6">
        ...
        <div className="mt-8">
            ...
            {/* Grid Layout: 1 columna en móvil, 12 columnas en escritorio */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                
                {/* COLUMNA IZQUIERDA (Estado de Calificación) - Ocupa 5 espacios */}
                <div className="lg:col-span-5">
                    <QualificationStatus 
                        puntosActuales={dashboardData.points} // Usamos el dato real de tu API
                        puntosMeta={93} // Puntos mínimos configurables (hardcodeado por ahora)
                    />
                </div>

                {/* COLUMNA DERECHA (Gráfica Anual) - Ocupa 7 espacios */}
                <div className="lg:col-span-7">
                    {/* NOTA: Como tu API 'fetchDashboardData' aun no trae el histórico anual,
                       el componente usará los datos de prueba (mock) por defecto.
                       Cuando actualices tu backend, le pasarás: data={dashboardData.historyPoints}
                    */}
                    <AnnualPerformanceChart />
                </div>
                {/* Solo mostramos esto si hay inversiones activas (length > 0) */}
        {dashboardData.investments.length > 0 && (
          <div className="mt-8">
            <Card>
              <CardHeader>
              ...
              <CardContent>
                {/* Le pasamos el ID de la primera inversión activa */}
