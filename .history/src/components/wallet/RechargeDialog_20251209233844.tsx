        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                {/* USAMOS LOS IDs DE LA BASE DE DATOS */}
                <SelectItem value="1">Yape</SelectItem>  {/* ID 1 = Yape */}
                <SelectItem value="3">Plin</SelectItem>  {/* ID 3 = Plin (Lo acabamos de crear) */}
                
                {/* ID 4 = Transferencia (Este activa la tarjeta azul) */}
